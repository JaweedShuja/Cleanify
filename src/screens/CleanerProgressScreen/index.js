...
class CleanerProgressScreen extends Component {
    static navigationOptions = {
      ...
      constructor(props){
          ...
          var t = setInterval(() => {
              this.props.navigation.navigate('CleanerOnTheWayScreen')
              clearInterval(t)
           ...
           <View style={styles.container}>
             <View style={styles.topContainer}>
                ...
                <View style={{
                    ...
                    <Text style={{fontSize:12, color:'gray'}}>Cleaner will arrive in 2 days</Text>
                </View>
                </View>
             </View>
...
export default CleanerProgressScreen
