...
class CleanerArrivedScreen extends Component {
    static navigationOptions = {
      ...
      constructor(props){
          ...
          var t = setInterval(() => {
            this.props.navigation.navigate('CleaningInProgressScreen')
            clearInterval(t)
             ...
             <View style={styles.topContainer}>
                ...
                >
                    ...
                    <View style={{alignItems:'center'}}>
                        <View style={{width:1, height:'42%', backgroundColor:'#E6E9ED'}}>

                        </View>
                        <View style={{height:15, width:15, backgroundColor:'#F90505', borderRadius:70,}}>
...
export default CleanerArrivedScreen
